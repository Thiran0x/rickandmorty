...
public class CharacterRepositoryImpl implements CharacterRepository{
    ...
    private static final Log LOGGER = LogFactory.getLog(CharacterRepositoryImpl.class);
    private static Environment env;
    private static RestTemplateBuilder restTemplateBuilder;

    @Autowired
    public CharacterRepositoryImpl(Environment env, RestTemplateBuilder restTemplateBuilder) {
